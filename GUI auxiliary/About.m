...
% Last Modified by GUIDE v2.5 28-Dec-2010 18:52:54
...
Img=image(IconData, 'Parent', handles.axesDanny);
set(handles.figure1, 'Colormap', IconCMap);

set(handles.axesDanny, ...
    'Visible', 'off', ...
    'YDir'   , 'reverse'       , ...
    'XLim'   , get(Img,'XData'), ...
    'YLim'   , get(Img,'YData')  ...
...
axes(handles.axesDanny);
imshow(imread('Danny.jpg'));
axes(handles.axesInbar);
imshow(imread('Inbar.jpg'));
...
function axesDanny_CreateFcn(hObject, eventdata, handles)
% hObject    handle to axesDanny (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called

% Hint: place code in OpeningFcn to populate axesDanny


% --- Executes during object creation, after setting all properties.
function axesInbar_CreateFcn(hObject, eventdata, handles)
% hObject    handle to axesInbar (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called

% Hint: place code in OpeningFcn to populate axesInbar
